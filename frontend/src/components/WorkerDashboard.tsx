          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 id="worker-dashboard-title" className="text-base font-bold text-white">Мониторинг Воркера</h2>
              ...
              <div className="flex items-center gap-2 text-xs text-slate-400">
                {isAdmin ? (
                  <span className="flex items-center gap-1 text-emerald-400 font-semibold bg-emerald-500/10 px-2.5 py-1 rounded-lg border border-emerald-500/20">
                    ...
                    <span>Режим Администратора: безлимитный запуск</span>
                  </span>
                ) : (
                  <div className="flex items-center gap-2">
                    <span className="flex items-center gap-1 text-amber-400 font-medium bg-amber-500/10 px-2.5 py-1 rounded-lg border border-amber-500/20">
                      <Key className="w-3.5 h-3.5" />
                      <span>Демо-доступ: {freeRunsRemaining} из 3 бесплатных запусков</span>
                    </span>
                    <button
                      onClick={onOpenAuth}
